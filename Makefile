...
obj_for_example=CThreadPool.o CThreadPoolItem.o IThreadPoolItemBase.o IThreadPoolItemExecutor.o example.o $(MY_LIB)/CScopeGuard.o
obj_for_example_ret=IThreadPoolItemBase.o example_ret.o $(MY_LIB)/CScopeGuard.o
...
$(MY_LIB)/CScopeGuard.o:
	$(MAKE) -C $(MY_LIB) CScopeGuard.o
